...
class MButtonTest(QWidget):
    ...
    def _init_ui(self):
        ...
        button_circle = MButton(icon='icon-delete', type=MButton.PrimaryType, text='Delete')
        button_circle2 = MButton(icon='icon-search', type=MButton.PrimaryType, text='Search')
        button_circle3 = MButton(icon='icon-browser', type=MButton.PrimaryType, text='Browser')
        button_circle4 = MButton(icon='icon-up', type=MButton.PrimaryType, text='Up')
        ...
        button_v1 = MButton(icon='icon-delete', type=MButton.InfoType, text='Delete')
        button_v2 = MButton(icon='icon-search', type=MButton.InfoType, text='Search')
        button_v3 = MButton(icon='icon-browser', type=MButton.InfoType, text='Browser')
        button_v4 = MButton(icon='icon-up', type=MButton.InfoType, text='Up')
