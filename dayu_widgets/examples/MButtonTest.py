...
class MButtonTest(QWidget, MFieldMixin):
    ...
    def _init_ui(self):
        ...
        button7 = MButton(text='Icon', icon=MIcon('trash_fill.svg'), type=MButton.IconType)
        button7.setCheckable(True)
        button_large = MButton(text='Large', type=MButton.PrimaryType, size=MView.LargeSize)
        button_default = MButton(text='Default', type=MButton.PrimaryType)
        button_small = MButton(text='Small', type=MButton.WarningType, size=MView.SmallSize)
        button_default.setDisabled(True)
        button_circle = MButton(icon=MIcon('trash_fill.svg', '#dddddd'), type=MButton.ErrorType, text='Delete')
        button_circle2 = MButton(icon=MIcon('search_line.svg', '#dddddd'), type=MButton.PrimaryType, text='Search')
        button_circle3 = MButton(icon=MIcon('folder_fill.svg', '#dddddd'), type=MButton.PrimaryType, text='Browser')
        button_circle4 = MButton(icon=MIcon('up_fill.svg', '#dddddd'), type=MButton.PrimaryType, text='Up')
        ...
        button_v1 = MButton(icon=MIcon('trash_fill.svg', '#eeeeee'), type=MButton.InfoType, text='Delete')
        button_v2 = MButton(icon=MIcon('search_line.svg', '#eeeeee'), type=MButton.InfoType, text='Search')
        button_v3 = MButton(icon=MIcon('folder_fill.svg', '#eeeeee'), type=MButton.InfoType, text='Browser')
        button_v4 = MButton(icon=MIcon('up_fill.svg', '#eeeeee'), type=MButton.InfoType, text='Up')
